...
def main():
    ...
    """
    # 配置路径
    base_path = '/aaa/process_data'  # 修改为你的数据文件夹路径
    json_config_path = '/aaa/process_data/站点变量.json'  # 修改为你的JSON配置文件路径
    output_path = '/aaa/process_data/merged_timeseries_data.csv'  # 输出文件路径
    year = 2022  # 数据年份
